...
def display_success_panel(
    console: Console, title: str, message: str, details: Optional[Dict[str, str]] = None
):
    """
...
def display_error_panel(
    console: Console, title: str, error: str, suggestion: Optional[str] = None
):
    """
...
def display_verification_table(console: Console, checks: Dict[str, tuple[bool, str]]):
    """
